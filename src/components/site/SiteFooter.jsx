    ...
    <footer className="bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            <h3 className="font-display text-2xl mb-2 text-[#ea580c] font-bold">MANGUEZAL</h3>
            <p className="text-white/60 text-sm max-w-md">
              Associação Atlética Acadêmica UPE — Medicina/UPE. Campeã geral do V e VI Intermed Pernambuco.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-white/10 pt-6 text-center text-white/40 text-xs">
          © {new Date().getFullYear()} Associação Atlética Acadêmica UPE — Manguezal. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
